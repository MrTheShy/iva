// Каталог веб-поисковых провайдеров для меню-визарда — зеркало scripts/lib/model-catalog.ts,
...
// Поллер работает в bare Node отдельно от eve-bundle и не импортирует граф agent-tool;
// поэтому факты авторизации продублированы здесь;
