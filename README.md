...
The bridge long-polls Telegram, so no public HTTPS, domain or webhook is needed. Iva runs as two systemd user services, two systemd watchdog timers and six in-process eve schedules — operations live in [docs/deploy.md](docs/deploy.md).
